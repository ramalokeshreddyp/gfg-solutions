<h2><a href="https://www.geeksforgeeks.org/problems/identical-matrices1042/1?page=4&difficulty=Basic&status=unsolved,attempted&sortBy=submissions">Identical Matrices</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two square matrices Grid1 and Grid2 with the same dimensions(NxN).Check whether they are identical or not.</span></p>
