<h2><a href="https://www.geeksforgeeks.org/problems/k-closest-elements3619/1?page=1&category=Linked%20List,STL&difficulty=Basic,Easy,Medium&status=unsolved,attempted&sortBy=submissions">K closest elements</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a sorted array of unique elements in increasing order, <strong>arr</strong>[] of <strong>n</strong> integers, and a value <strong>x</strong>. Find the K closest elements to <strong>x</strong> in <strong>arr</strong>[].<br>Keep the following points in mind:</span></p>
<ol>
